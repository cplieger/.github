...
1. **Add a second owner.** Invite a trusted second person as a co-maintainer
   and GitHub account/org owner, so issues can be triaged, changes merged, and
   releases cut by more than one person. Candidates: a developer family
