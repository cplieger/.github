...
live here once instead of being duplicated (this repo itself must stay public
for the inheritance to work). Precedence: a repo's own file wins, otherwise
...
- `GOVERNANCE.md` — governance model (single maintainer)
- `SECURITY.md` — private vulnerability reporting
- `SUPPORT.md` — where to get help
- `.github/FUNDING.yml` — Sponsor button (placeholder, disabled)
- `.github/PULL_REQUEST_TEMPLATE.md`
- `.github/ISSUE_TEMPLATE/` — bug + feature + question forms and chooser
  `config.yml`
